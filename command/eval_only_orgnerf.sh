...
declare -a StringArray=("gnerf_fvr_baseline_no_perturb64_esrganblock1_tanhinNerfDecoder" )
gpu1=4
...
for val in ${StringArray[@]}; do
  ...
  CUDA_VISIBLE_DEVICES=$gpu1 python eval.py \
    ...
    --chunk 2048 --img_wh 320 240  --nerf_out_dim $nerf_out_dim1 --model_mode $model_mode1 --decoder $decoder --decoder_num_res_blocks $decoder_num_res_blocks
