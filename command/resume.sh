...
nerf_out_dim1=64
exp_name1="1114_nerf_ds2v1"
loadname="1114_nerf_ds2"
# exp_name1="debug"
# model_mode1="1-1" #|1-4-1|1-1
# decoder='stylenerf'  #esrgan||stylenerf
ckpt_path1="/mnt/cephfs/dataset/NVS/nerfInWild/experimental_results/ckpts/${loadname}/last.ckpt"
...
cd /mnt/cephfs/dataset/NVS/nerfInWild/experimental_results/logs/$loadname/codes
